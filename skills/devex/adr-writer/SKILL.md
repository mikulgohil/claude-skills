---
name: adr-writer
description: Write Architecture Decision Records in the Nygard format — context, decision, consequences, and alternatives. Use when recording a significant technical decision or populating a docs/decisions/ directory.
author: Mikul Gohil
version: 1.0.0
license: MIT
