...
description: Search and rewrite code by AST structure using ast-grep — match function calls, imports, and class definitions semantically rather than by text. Use for precise, codebase-wide refactors. Requires the ast-grep (sg) CLI.
author: Mikul Gohil
version: 1.0.0
license: MIT
tags: [ast-grep, structural-search, refactor, codemod]
allowed-tools: [Bash]
---
