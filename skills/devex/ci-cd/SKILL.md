---
name: ci-cd
description: CI/CD pipeline patterns with GitHub Actions — build/test/deploy workflows, caching, matrix builds, release automation, and testing strategies. Use when writing or improving a pipeline.
author: Mikul Gohil
version: 1.0.0
license: MIT
tags: [ci-cd, github-actions, pipelines, release, automation]
