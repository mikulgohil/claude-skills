---
name: playwright-e2e
description: End-to-end testing with Playwright (CLI) — page objects, visual regression, axe-core accessibility checks, and CI integration. Use when writing, structuring, or debugging E2E tests.
author: Mikul Gohil
version: 1.0.0
license: MIT
tags: [testing, e2e, playwright, accessibility, visual-regression]
