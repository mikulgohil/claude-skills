---
name: shadcn-ui
description: Install and customize shadcn/ui components — selection, install order, dependency management, semantic-token theming, and recipes for forms, data tables, navigation, and modals. Use when adding shadcn/ui components to a React project.
author: Mikul Gohil
version: 1.0.0
license: MIT
