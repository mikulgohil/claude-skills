---
name: tailwind-v4
description: Tailwind CSS v4 — @theme configuration, utility patterns, responsive and dark-mode design, container queries, and v3-to-v4 migration. Use when styling with Tailwind or migrating a config to v4.
author: Mikul Gohil
version: 1.0.0
license: MIT
tags: [tailwind, tailwindcss, css, v4, responsive, dark-mode]
