...
description: Build server-first React with Next.js 16 App Router — Server/Client component boundaries, Cache Components, streaming SSR, Server Actions, and React 19 patterns. Use when working in app/, deciding server vs client, or debugging hydration and serialization issues.
author: Mikul Gohil
version: 1.0.0
license: MIT
tags: [frontend, react, react-19, nextjs-16, server-components, streaming]
