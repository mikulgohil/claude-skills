---
name: zustand-state
description: Zustand 5.x state-management patterns — slices, middleware order, Immer, persistence, useShallow selectors, and devtools. Use when adding or refactoring client state with Zustand instead of Redux or Context.
author: Mikul Gohil
version: 1.0.0
license: MIT
tags: [zustand, state-management, react, immer, middleware]
