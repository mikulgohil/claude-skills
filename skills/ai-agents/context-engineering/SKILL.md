...
description: Understand and optimize how context is structured in agent systems — the components, mechanics, and constraints of an agent's context window. Use when writing or tuning commands, skills, and sub-agent prompts.
author: Mikul Gohil
version: 1.0.0
license: MIT
tags: [ai, agents, context, prompt-engineering]
---
