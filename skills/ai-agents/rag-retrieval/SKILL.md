---
name: rag-retrieval
description: Retrieval-Augmented Generation patterns — embeddings, chunking, hybrid search, contextual retrieval, HyDE, reranking, agentic RAG, multimodal RAG, and pgvector. Use when building or tuning a RAG pipeline.
author: Mikul Gohil
version: 1.0.0
license: MIT
tags: [rag, retrieval, llm, embeddings, hyde, reranking, pgvector]
