...
description: Design multi-agent architectures for complex tasks — decomposition, specialization, and orchestration. Use when a task exceeds single-agent context limits or splits naturally into specialized subtasks.
author: Mikul Gohil
version: 1.0.0
license: MIT
