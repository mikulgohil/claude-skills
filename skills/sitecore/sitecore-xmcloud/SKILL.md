...
description: Sitecore XM Cloud and JSS expertise — content modeling, component development, serialization, headless architecture with Content SDK v2, and SXA patterns. Auto-invoked when working in Sitecore projects.
author: Mikul Gohil
version: 1.0.0
license: MIT
