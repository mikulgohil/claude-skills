---
name: api-design
description: REST and GraphQL API design — resource modeling, versioning strategies, pagination, OpenAPI, and RFC 9457 problem-details error handling. Use when designing or reviewing an API surface.
author: Mikul Gohil
version: 1.0.0
license: MIT
tags: [api-design, rest, graphql, versioning, openapi, rfc9457]
