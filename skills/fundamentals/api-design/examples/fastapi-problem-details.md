...
class ConflictError(ProblemException):
    ...
    def __init__(
        ...
        super().__init__(
            status_code=409,
            problem_type="https://api.example.com/problems/resource-conflict",
...
class AuthenticationError(ProblemException):
    ...
    def __init__(self, detail: str = "Authentication is required"):
        super().__init__(
            status_code=401,
            problem_type="https://api.example.com/problems/authentication-required",
...
class AuthorizationError(ProblemException):
    ...
    def __init__(
        ...
        super().__init__(
            status_code=403,
            problem_type="https://api.example.com/problems/insufficient-permissions",
...
async def test_not_found_returns_problem_detail(client: AsyncClient):
    ...
    assert problem["type"] == "https://api.example.com/problems/resource-not-found"
