...
### Real-World Example: the project's PII Columns
...
**the project Migration:** `20251218_backfill_chunks_tsvector.py` (actual example)
...
the project uses timestamp-based naming for clarity:
...
psql -d myapp -c "CREATE INDEX CONCURRENTLY idx_chunks_vector_hnsw ON analysis_chunks USING hnsw (vector vector_cosine_ops) WITH (m = 16, ef_construction = 64);"
```
...
**the project Example:** `20251210_add_cascade_delete.py`
...
**the project Example:** `500313d1cac9_merge_sprint_12_migrations.py`
