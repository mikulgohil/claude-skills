...
description: Database design and migration patterns — SQL/NoSQL schema modeling, normalization, indexing, and versioned migrations. Use when designing schemas or evolving a database safely.
author: Mikul Gohil
version: 1.0.0
license: MIT
tags: [database, schema, migrations, sql, nosql, indexing]
