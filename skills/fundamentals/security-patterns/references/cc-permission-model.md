...
These are the facts the project security guidance depends on — get them wrong and a
...
Implication for the project's multi-agent flows (agent-orchestration, mcp-patterns):
