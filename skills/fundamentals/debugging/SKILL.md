---
name: debugging
description: Systematic debugging methodology — reproduce, isolate, hypothesize, verify — plus language-specific debuggers and common-scenario playbooks (leaks, races, deadlocks, crashes). Use when tracking down a bug of unknown cause.
author: Mikul Gohil
version: 1.0.0
license: MIT
tags: [debugging, root-cause, profiling, race-condition, memory-leak]
