...
description: TypeScript type-system patterns — generics, conditional and utility types, strict mode, discriminated unions, type guards, and ecosystem idioms (Zod/Valibot). Use when modeling types, tightening strictness, or untangling complex generics.
author: Mikul Gohil
version: 1.0.0
license: MIT
tags: [typescript, types, generics, strict-mode, zod]
